	...
	systemd.services = {
		libvirtd = {
			...
			preStart = ''
				...
				ln -sf /home/rumman/.nixos-config/scripts/vm/qemu /var/lib/libvirt/hooks/qemu
				ln -sf /home/rumman/.nixos-config/vm/kvm/kvm.conf /var/lib/libvirt/hooks/kvm.conf
				ln -sf /home/rumman/.nixos-config/vm/vbios/rx6800xt.rom /var/lib/libvirt/vgabios/patched.rom
				ln -sf /home/rumman/.nixos-config/scripts/vm/start.sh /var/lib/libvirt/hooks/qemu.d/Windows_11_g/prepare/begin/start.sh
				ln -sf /home/rumman/.nixos-config/scripts/vm/stop.sh /var/lib/libvirt/hooks/qemu.d/Windows_11_g/release/end/stop.sh
				# ln -sf /home/rumman/.nixos-config/scripts/vm/start.sh /var/lib/libvirt/hooks/qemu.d/macOS_Sequoia_g/prepare/begin/start.sh
				# ln -sf /home/rumman/.nixos-config/scripts/vm/stop.sh /var/lib/libvirt/hooks/qemu.d/macOS_Sequoia_g/release/end/stop.sh
